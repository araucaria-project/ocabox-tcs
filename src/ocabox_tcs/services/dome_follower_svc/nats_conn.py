...
class NatsConn:
    ...
    async def rpc_follow_on(self, rpc: Rpc) -> None:
        self.manager.logger.info(f'Follow on rpc request received')
        ...
        self.manager.logger.info(f'Sent rpc response: follow on')

    async def rpc_follow_off(self, rpc: Rpc) -> None:
        self.manager.logger.info(f'Follow off rpc request received')
        ...
        await rpc.response_now(data=data, meta=meta)
        self.manager.logger.info(f'Sent rpc response: follow off')

    async def rpc_state(self, rpc: Rpc) -> None:
        self.manager.logger.info(f'State rpc request received')
        data = {
        ...
        await rpc.response_now(data=data, meta=meta)
        self.manager.logger.info(f'Sent rpc response: status')
    ...
    async def start_responders(self) -> None:
        ...
        self.manager.logger.info(f"All responders started")
    ...
    async def get_obs_cfg(self) -> Dict:
        ...
        self.manager.logger.info(f'Obtained Observatory Config. Published: {_obs_cfg["published"]}')
        return _obs_cfg
