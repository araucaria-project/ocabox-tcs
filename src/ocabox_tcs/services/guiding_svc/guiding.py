...
@config('guiding_svc.guiding')
@dataclass
class GuidingServiceConfig(BaseServiceConfig):
...
@service('guiding_svc.guiding')
class GuidingService(BaseBlockingPermanentService):
    ...
    async def on_start(self):
        ...
        self.svc_logger.info(
            f"Starting guiding service, with interval: {self.svc_config.interval}"
        )
    ...
    async def on_stop(self):
        ...
        self.svc_logger.info(f"Stopping service guiding")
